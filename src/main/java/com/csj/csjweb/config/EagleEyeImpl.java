...
import com.csj.csjweb.exception.SignValidException;
import com.csj.csjweb.util.CryptUtil;
import com.csj.csjweb.util.Result;
import com.csj.csjweb.util.SignUtil;
...
public class EagleEyeImpl {
    ...
    public Object around(ProceedingJoinPoint pjp)throws Throwable{
        ...
        //eagleEye.count(); TODO 这里可以获取访问次数判断
